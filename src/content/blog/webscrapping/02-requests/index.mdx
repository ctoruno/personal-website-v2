...
summary: "Web Scraping is an increasingly popular tool to gather information from the web. In the second part of this series, I use the requests and BeautifulSoup Python libraries to extract information from a website."
date: 2022-11-17
topic: "Webscrapping"
series: webscrapping
part: 2
