...
summary: "In the third part of this series, I use the Selenium library to locate web elements and extract information from dynamic web sites."
date: 2022-12-09
topic: "Webscrapping"
series: webscrapping
part: 3
